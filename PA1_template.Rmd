...
#### Plot of the number of Steps taken each day
```{r, echo=TRUE}
...
Max Number of Steps 5-minute interval: `r maxNumberOfStepsInterval`
...
The strategy I adoptis to fill missing values with the mean for that 5-minute interval.
